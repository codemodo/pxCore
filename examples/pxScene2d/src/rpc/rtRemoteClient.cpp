...
rtRemoteClient::rtRemoteClient(rtRemoteEnvPtr env, int fd,
  sockaddr_storage const& local_endpoint, rtEndpointAddr const& remote_endpoint)
...
rtRemoteClient::rtRemoteClient(rtRemoteEnvPtr env, rtEndpointAddr const& remote_endpoint)
