...
{
public:
  rtRemoteClient(rtRemoteEnvironment* env, int fd, rtRemoteAddrPtr const& local_endpoint,
    rtRemoteAddrPtr const& remote_endpoint);
  rtRemoteClient(rtRemoteEnvironment* env, rtRemoteAddrPtr const& remote_endpoint);
  ~rtRemoteClient();
